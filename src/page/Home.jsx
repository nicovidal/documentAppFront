...
export const Home = () => {
    ...
    useEffect(() => {
        const fetchDocuments = async () => {
            ...
            setDocuments(data); // Actualizar estado con los datos obtenidos
        };
    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <label htmlFor="rut_cliente" className="form-label">Rut Cliente</label>
                    <input
                        type="text"
                        className="form-control"
                        id="rut_cliente"
                ...
                <div className="mb-3">
                    <label htmlFor="respaldo_solicitud" className="form-label">Respaldo Solicitud</label>
                    <input
                        type="url"
                        className="form-control"
                ...
                <div className="mb-3">
                    <label htmlFor="numeroCaja" className="form-label">Número de Caja</label>
                    <input
                        type="text"
                        className="form-control"
                        id="numeroCaja"
                    ...
                    {documents.length > 0 ? (
                        documents.map((doc) => (
                            <tr key={doc.id}>
                                ...
                                <td>
                                    <a href={doc.respaldo_solicitud} target="_blank" rel="noopener noreferrer">
